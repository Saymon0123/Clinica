    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1" htmlFor="nome">Nome do serviço</label>
            <input
              id="nome"
              value={nome}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1" htmlFor="duracao">Duração (min)</label>
              <input
                id="duracao"
                type="number"
                min={5}
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1" htmlFor="preco">Preço (R$)</label>
              <input
                id="preco"
                inputMode="decimal"
                value={preco}
