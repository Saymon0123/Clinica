    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-lg shadow-lg">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Adicionar cliente</h2>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1" htmlFor="nome">Nome</label>
            <input
              id="nome"
              value={nome}
          ...
          <div>
            <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1" htmlFor="telefone">Telefone</label>
            <input
              id="telefone"
              value={telefone}
          ...
          <div>
            <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1" htmlFor="aniversario">Aniversário</label>
            <input
              id="aniversario"
              type="date"
              value={aniversario}
          ...
          <div>
            <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1" htmlFor="observacao">Observação (opcional)</label>
            <textarea
              id="observacao"
              value={observacao}
