...
export function ConexaoPage() {
  ...
  return (
    <div>
      <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Conexão</h1>

      <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6 max-w-md">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <div className="text-sm font-medium text-gray-900 dark:text-gray-100">WhatsApp</div>
        ...
        {status === 'open' ? (
          ...
          <div className="flex flex-col items-center gap-3 mb-4">
            <img
              ...
              className="w-56 h-56 border border-gray-200 dark:border-gray-700 rounded"
            />
        ...
        <div className="flex gap-2">
          {status === 'open' ? (
            <button
              ...
              disabled={loading}
              className="flex-1 border border-gray-300 dark:border-gray-600 rounded px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 disabled:opacity-50"
            >
