...
export function CriarContaPage() {
  ...
  if (enviado) {
    return (
      <div className="min-h-[100dvh] flex items-center justify-center bg-background px-4">
        <div className="surge w-full max-w-sm bg-surface border border-border rounded-2xl shadow-sm p-5 space-y-4 shadow-[0_16px_40px_-24px_color-mix(in_srgb,var(--foreground)_45%,transparent)]">
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-background px-4 py-10">
      <div className="surge w-full max-w-sm bg-surface border border-border rounded-2xl shadow-sm p-5 space-y-5 shadow-[0_16px_40px_-24px_color-mix(in_srgb,var(--foreground)_45%,transparent)]">
